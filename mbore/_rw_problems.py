"""
  ...
  I re-implemented the RE problem set by referring to its C source code
  (reproblem.c). While variables directly copied from the C source code are
  written in CamelCase, the other variables are written in snake_case.
...
class RE22:
    ...
    def evaluate(self, x):
        ...
        # Reference: getNearestValue_sample2.py
        # (https://gist.github.com/icchi-h/1d0bb1c52ebfdd31f14b3e811328390a)
...
class RE36:
    ...
    def evaluate(self, x):
        ...
        # Second original objective function
        # (the maximum value among the four variables)
        f[1] = max([x1, x2, x3, x4])
...
class RE41:
    ...
    def evaluate(self, x):
        ...
        g[4] = 32 - (
            28.98 + 3.818 * x3 - 4.2 * x1 * x2 + 1.27296 * x6 - 2.68065 * x7
        )
        g[5] = 32 - (
            33.86
            + 2.95 * x3
